...
INSERT INTO scheme(id, code, name, validfrom, validto, isactive, description, fundid,createddate, lastmodifieddate, createdby,lastmodifiedby,state_code) VALUES
...
INSERT INTO scheme(id, code, name, validfrom, validto, isactive, description, fundid,createddate, lastmodifieddate, createdby,lastmodifiedby,state_code) VALUES
 ...
 INSERT INTO scheme(id, code, name, validfrom, validto, isactive, description, fundid,createddate, lastmodifieddate, createdby,lastmodifiedby,state_code) VALUES
 (nextval('seq_scheme'),'CS12','Pavers Block Scheme','04/01/2024','03/31/2030',true,NULL,(select id from fund where code='CF'),now(),now(),1,1, 60) ON CONFLICT DO NOTHING;
 ...
 INSERT INTO scheme(id, code, name, validfrom, validto, isactive, description, fundid,createddate, lastmodifieddate, createdby,lastmodifiedby,state_code) VALUES
 (nextval('seq_scheme'),'SS04','State Owned Priority Development (SOPD)','04/01/2024','03/31/2030',true,NULL,(select id from fund where code='SF'),now(),now(),1,1, 01) ON CONFLICT DO NOTHING;
