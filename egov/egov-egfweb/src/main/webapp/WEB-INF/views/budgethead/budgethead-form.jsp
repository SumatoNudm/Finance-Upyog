			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">
						<spring:message code="lbl.budget.head" text="Budget Head" />
					</div>
				</div>
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label text-right">
							<spring:message code="lbl.name" text="Name" /> <span class="mandatory"></span> </label>
						<div class="col-sm-6 add-margin">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label text-right">
							<s:text name="Program/Scheme Applicable" />:<span class="mandatory1">*</span>
						</label>

						<div class="col-sm-6 add-margin">
							<span id="yesradiobuttonspan" style="float:left; margin-right:15px;">
								<input type="radio" id="yesradiobutton" name="program" value="yes" /> Yes
							</span>
					...
					<input type="hidden" name="budgetHead" value="${budgetHead.id}" />