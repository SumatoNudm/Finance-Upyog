                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered budget-table" id="dynamicTable">
                                ...
                                <tr>
                                    <form:hidden path="opening.id" id="opening.id"/>
                                ...
                                <tr>
                                    <td colspan="6" >
                                        <form:hidden path="closing.id" id="closing.id"/>
                                        <form:hidden path="closing.budgetGroup" id="closing.budgetGroup"/>
                                        <form:hidden path="closing.function.id" id="closing.functionid"/>
